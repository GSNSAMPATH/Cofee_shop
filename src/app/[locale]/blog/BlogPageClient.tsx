...
function urlFor(source: any) {
  // Return a fallback image if mainImage is missing
  return source ? builder.image(source).url() : "https://via.placeholder.com/800x600?text=No+Image";
}
...
export default function BlogPageClient({ blogs, locale }: BlogPageClientProps) {
