            ...
            <section >
                ...
                <div className="w-full h-200 bottom-50 flex justify-between mx-auto ">
                    <div className="w-full h-200 ">
                        ...
                        <div className="relative  lg:left-100 xl:left-150 2xl:left-170 mt-20 xl:top-[-30]   lg:top-[-30] md:top-[-20] z-0 bg-[#E3D7C5] p-3 h-15 max-w-sm flex flex-col items-center lg:block lg:flex-row justify-center rounded-4xl shadow-lg ">
