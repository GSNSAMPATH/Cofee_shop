...
export default function About() {
    return (
        <section className=" h-auto bg-black w-full">
            ...
            <section className=" py-16 bg-black h-500">
                ...
                <div className="w-full h-50 md:max-w-7xl mx-auto ">               
                    ...
                    <a className="absolute text-center mx-auto font-inriasans mb-6  text-gray-300 sm:max-w-full max-w-80 mr-30 leading-relaxed max-w-10">
                    ...
                    <div className="h-200 w-full items-center justify-between md:flex md:max-w-7xl mx-auto">
                        <div className="h-100 w-full">
                            <div className="h-50 w-full mt- left-135 w-auto mx-auto">
                                <h2 className=" text-3xl text-white font-inriasans font-bold mb-6 ml-50">
                                    OUR VISION
                                </h2>
                            ...
                            <div className="absolute mt-40 w-auto">
                            <Image 
                                src="/10caa26122896ca5dd4c53868248e23729604929.png"
                                alt="about"
                                width={400}
                                height={400}
                                className="object-cover opacity-900 hidden lg:block"
                                priority
                                />
                            </div>
                        </div>
                        <div className="h-200 w-full">
                            <div className="absolute mt-40 left-135 w-auto">
                                <Image 
                            ...
                            <div className="h-200 w-full mt-230 left-135 w-auto mx-auto">
                            <h2 className=" text-3xl text-white font-inriasans font-bold mb-6 ml-50">
                            OUR VISION
                            </h2>
                            <a className="text-paragraph font-inriasans mb-6 leading-relaxed text-white ">
