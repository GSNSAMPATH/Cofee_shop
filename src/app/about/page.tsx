...
export default function About() {
    return (
        <section className=" h-auto bg-black w-full">
            ...
            <section className=" py-16 bg-black h-320 mx-5">
                <div className="absolute  xl:left-300 lg:left-200 md:left-100 ml-20 hidden lg:block h-250 top-60 w-36 bg-[#4E2A20] rounded-lg">
                    ...
                    <h2 className="text-white font-sans text-3xl font-regular sm:text-center mb-10 relative mx-auto ">
                        OUR STORY
                        <span className="block sm:mx-auto w-16 h-[2px] bg-red-600 mt-2 mb-10"></span>
                    </h2>
                    <a className="absolute sm:text-center font-inriasans mb-6  text-gray-300 sm:max-w-full  lg:px-20 leading-relaxed ">
                    ...
                    <div className="lg:h-200 w-full  lg:items-center lg:justify-between lg:flex  mx-auto xl:w-full">
                        <div className="lg:h-100 w-full lg:mx-20 lg:px-0 ">
                            <div className="h-50 lg:mt-0 mt-100 sm:mt-60 w-full text-justify s:mpx-20 lg:mt-0 w-auto mx-auto">
                                <h2 className=" text-3xl font-sans text-white font-inriasans font-regular mb-6 ">
                                    OUR VISION
                                </h2>
                            ...
                            <div className="mt-50 sm:mt-10  xl:mx-20 h-100 lg:mt-20 w-auto w-full flex lg:block items-center justify-center ">
                                <Image
                        ...
                        <div className="h-200 w-full lg:mx-20 md:mx-0 ">
                            ...
                            <div className="h-200  w-full lg:mt-200 mt-20 w-full text-justify lg:px-2 mt-10 lg:mt-0 lg:left-135 w-auto mx-auto">
                            <h2 className=" text-3xl font-sans text-white  font-regular mb-6 lg:ml-0">
                            OUR MISSION
                            </h2>
