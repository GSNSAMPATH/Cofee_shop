        ...
        <section className=" h-auto bg-black w-full">
            ...
            <section className=" py-16  bg-black h-350">
                <div className="absolute  xl:left-300 lg:left-200 md:left-100 ml-20 hidden lg:block h-250 top-60 w-36 bg-[#4E2A20] rounded-lg">
                    ...
                    <a className="absolute text-center font-inriasans mb-6  text-gray-300 sm:max-w-full  lg:px-45 leading-relaxed ">
                ...
                <div className="w-full lg:text-left text-center h-50 md:max-w-full  ">   
                    <div className="lg:h-200 w-full  lg:items-center lg:justify-between lg:flex  mx-auto xl:w-full">
                        <div className="lg:h-100 w-full lg:mx-20 lg:px-0 ">
                            <div className="h-50 lg:mt-7 mt-100 sm:mt-60 w-full text-center s:mpx-20 lg:mt-0 w-auto mx-auto">
                                <h2 className=" text-3xl text-white font-inriasans font-bold mb-6 text-center">
                                    OUR VISION
                                </h2>
                            ...
                            <div className="mt-50 sm:mt-10  xl:mx-20 h-100 lg:mt-40 w-auto w-full flex lg:block items-center justify-center ">
                                <Image
                        ...
                        <div className="h-200 w-full  lg:mx-20 md:mx-0 ">
                            <div className="hidden lg:block z-10 absolute mt-40 left-135 w-auto ">
                                <Image 
                            ...
                            <div className="h-200  w-full lg:mt-230 mt-20 w-full text-center lg:px-20 mt-10 lg:mt-0 lg:left-135 w-auto mx-auto">
