    ...
    <nav className="bg-transparent relative  w-full z-50">
      <div className=" mx-auto md:px-30 px-10 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-8 text-white font-medium">
          ...
          <Link href="/villas" className="hover:text-teal-600 transition px-4  border border-red-500 rounded-full">Villas</Link>
          <Link href="/gallery" className="hover:text-teal-600 transition px-4  border border-red-500 rounded-full">Gallery</Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-white shadow-lg">
          <div className="flex flex-col space-y-4 px-6 py-4 text-gray-700 font-medium">
            ...
            <Link href="/villas" onClick={toggleMenu} className="hover:text-teal-600">Villas</Link>
